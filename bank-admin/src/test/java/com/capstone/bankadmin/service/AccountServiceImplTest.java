package com.capstone.bankadmin.account;
...
public class accountServiceImplTest {
	 ...
	 public void getAllAccountDetailsTest() {
		 ...
		 when(repo.findAll()).thenReturn(
				 Stream.of( new Account(12,"1",5000,"Saving","Active"),new Account(12,"1",15000,"Saving","Inactive")).collect(Collectors.toList()));
		 assertEquals(2,service.getAllAccountDetails().size());
	 }
	 @Test
	 public void deleteAccountTest() {
		   Account account= new Account(12,"1",5000,"Saving","Active");
